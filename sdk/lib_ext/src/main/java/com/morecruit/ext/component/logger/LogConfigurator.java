...
class LogConfigurator {
    ...
    /**
     * @param fileName  Name of the log file
     * @param rootLevel Log level for the root com.morecruit.ext.component.logger
     */
    ...
    /**
     * Sets the level of com.morecruit.ext.component.logger with name <code>loggerName</code>.
